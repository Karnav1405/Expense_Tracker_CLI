...
class CSV:
    ...
    def get_transaction(cls, start_date, end_date):
        ...
        if filtered_df.empty:
            print("No transactions found in this given date range. ")
        else:
            print(f"Transaction form {start_date.strftime(CSV.FORMAT)} to {end_date.strftime(CSV.FORMAT)}")
